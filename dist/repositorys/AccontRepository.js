...
var UserRepository = /** @class */ (function (_super) {
    ...
    UserRepository.prototype.findByDate = function (date) {
        return __awaiter(this, void 0, void 0, function () {
            var findAcconts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findOne({
                            where: { date: date }, // ou date: date
                        })];
                    case 1:
                        findAcconts = _a.sent();
                        return [2 /*return*/, findAcconts || null];
                }
            });
        });
    };
    UserRepository = __decorate([
        typeorm_1.EntityRepository(Accont_1.default)
    ], UserRepository);
